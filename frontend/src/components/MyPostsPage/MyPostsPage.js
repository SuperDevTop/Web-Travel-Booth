  ...
  return (
    <div className="myPostsPage-container w-100">
      ...
      <div className="position-relative d-flex align-items-center justify-content-center pb-3">
          ...
          <h1 className="position-absolute text-uppercase text-primary" style={{fontSize:"3.5rem"}}>Post</h1>
      </div>
        ...
        {posts.map(post => (
          <Col key={post._id} sm={12} md={6} lg={4} xl={3}>
            <Card className="p-3 rounded">
              ...
              <Link className="post-edit-button w-100 text-center fw-semibold" to={`/post_edit/${post._id}`}>
                  Edit
              </Link>
            </Card>
          </Col>
