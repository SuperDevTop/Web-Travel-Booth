      ...
      <div className="container" style={{marginTop:"75px"}}>
        ...
        <div className="row">
          <div className="col-lg-8 col-md-8 mb-5 mx-auto">
            <div className="mb-4">
            <h1 className="font-weight-medium mb-4 text-center" style={{fontSize:"2.5rem"}}>{post.title}</h1> 
              ...
              <p>
                <span className="firstCharacter">{String(post.details).substring(0, 1)}</span>
                {String(post.details).substring(1)}
              </p>             
            </div>                              
          </div>
