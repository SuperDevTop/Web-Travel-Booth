...
*/
  ...
  const submitHandler = async (e) => {
    ...
    if (!details)
      toast({
        title: "Error Occured!",
        description: "Input Post Details",
        status: "error",
        position: "top-right",
        duration: 5000,
        isClosable: true,
  ...
  return (
    <div className="capturePage-container w-100">
      <div className="content-container" style={{paddingTop:"65px"}}>
          ...
          <Form>
            ...
            <Form.Group controlId="privacy" className="my-2">
              <Form.Check
                ...
                name="chkPublic"
                value="Public"
                onChange={(e) => setChkPublic(e.target.value, 1)}
              ></Form.Check>
              <Form.Check
                type="radio"
                label="Private"
                ...
                name="chkPrivate"
                value="Private"
                onChange={(e) => setChkPublic(e.target.value, 2)}
              ></Form.Check>
            </Form.Group>
            <Button variant="primary" className="my-2" onClick={submitHandler}>
              Submit
            </Button>
          </Form>
        </div>
